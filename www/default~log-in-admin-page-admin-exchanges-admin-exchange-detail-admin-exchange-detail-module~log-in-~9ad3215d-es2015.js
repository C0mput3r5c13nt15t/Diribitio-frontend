...
let ProjectsService = class ProjectsService {
    ...
    toogleEditableProject(projectID, editable) {
        ...
        this.http.put(this.backendUrl + 'admins/toogle_editable/' + projectID, sendData, options).subscribe(data => {
            this.alert.alert(data.message);
            this.update.emit();
        }, error => {
            this.alert.error('Aktualisierung des Projektes fehlgeschlagen!', error.error);
...
//# sourceMappingURL=default~log-in-admin-page-admin-exchanges-admin-exchange-detail-admin-exchange-detail-module~log-in-~9ad3215d-es2015.js.map