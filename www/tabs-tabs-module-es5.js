(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
    ...
    function srcAppTabsTabsRouterModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_config_app_config_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/config/app.config.json */
      "./src/config/app.config.json");

      var src_config_app_config_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(
      /*! src/config/app.config.json */
      "./src/config/app.config.json", 1);

      var projectNoun = src_config_app_config_json__WEBPACK_IMPORTED_MODULE_5__.project_noun;
      var projectsNoun = src_config_app_config_json__WEBPACK_IMPORTED_MODULE_5__.projects_noun;
      var eventName = src_config_app_config_json__WEBPACK_IMPORTED_MODULE_5__.event_name;
      var routes = [{
        path: eventName,
