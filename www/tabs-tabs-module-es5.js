  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
    ...
    function MJr(module, __webpack_exports__, __webpack_require__) {
      ...
      var TabsPage = /*#__PURE__*/function () {
        function TabsPage(screensizeService, auth, alertService, config) {
          var _this = this;
          ...
          this.alertService.update.subscribe(function () {
            return _this.getAlertsAndErrors();
          });
          var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["interval"])(this.maxLifetime / 2);
          this.regularInterval = source.subscribe(function () {
            return _this.deleteOldAlertsAndErrors(_this.maxLifetime);
          });
        }
        ...
        _createClass(TabsPage, [{
          ...
          key: "deleteOldAlertsAndErrors",
          value: function deleteOldAlertsAndErrors(maxLifetime) {
            var _this2 = this;

            var now = new Date().getTime();
            this.alertsAndErrors.forEach(function (alert) {
              if (now - alert.time > maxLifetime) {
                _this2.fadeOutAlertOrError(alert.id);
              }
            });
          }
        }, {
          key: "fadeOutAlertOrError",
          value: function fadeOutAlertOrError(alertID) {
            var _this3 = this;
            ...
            element.onanimationend = function () {
              _this3.deleteAlertOrError(alertID);
            };
          }
        }, {
          key: "deleteAlertOrError",
          value: function deleteAlertOrError(alertID) {
