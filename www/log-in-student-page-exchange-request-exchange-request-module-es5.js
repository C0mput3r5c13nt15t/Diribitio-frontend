(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["log-in-student-page-exchange-request-exchange-request-module"], {
    ...
    /***/
    function RAMv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function VX3g(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function otn3(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_exchange_request_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./exchange-request.page.html */
      "RAMv");
      /* harmony import */


      var _exchange_request_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ExchangeRequestPage = /*#__PURE__*/function () {
        function ExchangeRequestPage(activatedRoute, router, studentsService, exchangesService, alertCtrl, alert, config) {
        ...
        _createClass(ExchangeRequestPage, [{
          ...
          value: function submit() {
            ...
            this.studentsService.getStudentID(this.exchangePartner).subscribe(function (data) {
              // tslint:disable-next-line:disable-next-line: triple-equals
              if (data.id != 0 && _this3.loadedStudent.exchange_id == 0) {
                _this3.exchangesService.createExchange(data.id).subscribe(function (response) {
                  _this3.alert.alert(response.message);

                  _this3.router.navigate([_this3.eventName + '/Schüler/' + _this3.studentUrl]);
      ...
      ExchangeRequestPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
...
//# sourceMappingURL=log-in-student-page-exchange-request-exchange-request-module-es5.js.map