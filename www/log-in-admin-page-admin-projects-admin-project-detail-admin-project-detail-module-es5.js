(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["log-in-admin-page-admin-projects-admin-project-detail-admin-project-detail-module"], {
    ...
    /***/
    function RvP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JPTK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ViP9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function fwlB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_admin_project_detail_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./admin-project-detail.page.html */
      "JPTK");
      /* harmony import */


      var _admin_project_detail_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        _createClass(AdminProjectDetailPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.activatedRoute.paramMap.subscribe(function (paramMap) {
              ...
              _this.projectId = Number(paramMap.get('ProjectID'));
            });
            this.getSchedule();
            this.getProject();
          ...
          value: function getProject() {
            ...
            this.projectsService.getProjectAdmin(this.projectId).subscribe(function (data) {
              if (!data.data) {
                _this3.router.navigate([_this3.eventName + '/Admin/' + _this3.adminUrl]);
              } else {
                _this3.loadedProject = data.data;
              }
            });
          }
        }, {
            ...
            this.alertCtrl.create({
              ...
              buttons: [{
                ...
                handler: function handler() {
                  _this4.projectsService.deleteProject(_this4.loadedProject.id);

                  _this4.router.navigate([_this4.eventName + '/Admin/' + _this4.adminUrl + '/' + _this4.projectsNoun]);
                }
              }]
      ...
      AdminProjectDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
