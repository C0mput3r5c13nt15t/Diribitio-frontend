...
var map = {
	...
	"./log-in/leader-page/project-administration/project-edit/project-edit.module": [
		"./src/app/log-in/leader-page/project-administration/project-edit/project-edit.module.ts",
		"common",
		"log-in-leader-page-project-administration-project-edit-project-edit-module"
	],
...
/* harmony import */ var _screensize_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./screensize.service */ "./src/app/screensize.service.ts");
...
const routes = [
    ...
    {
        path: 'admin-tokens',
        loadChildren: () => __webpack_require__.e(/*! import() | log-in-admin-page-admin-tokens-admin-tokens-module */ "log-in-admin-page-admin-tokens-admin-tokens-module").then(__webpack_require__.bind(null, /*! ./log-in/admin-page/admin-tokens/admin-tokens.module */ "./src/app/log-in/admin-page/admin-tokens/admin-tokens.module.ts")).then(m => m.AdminTokensPageModule)
    },
    {
        path: 'admin-logs',
...
/* harmony import */ var _screensize_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./screensize.service */ "./src/app/screensize.service.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_assets_config_app_config_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/assets/config/app.config.json */ "./src/assets/config/app.config.json");
var src_assets_config_app_config_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/app.config.json */ "./src/assets/config/app.config.json", 1);
/* harmony import */ var src_assets_config_backend_config_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/assets/config/backend.config.json */ "./src/assets/config/backend.config.json");
var src_assets_config_backend_config_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/backend.config.json */ "./src/assets/config/backend.config.json", 1);
/* harmony import */ var src_assets_config_conditions_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/assets/config/conditions.json */ "./src/assets/config/conditions.json");
var src_assets_config_conditions_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/conditions.json */ "./src/assets/config/conditions.json", 1);
/* harmony import */ var src_assets_config_content_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/assets/config/content.json */ "./src/assets/config/content.json");
var src_assets_config_content_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/content.json */ "./src/assets/config/content.json", 1);
/* harmony import */ var src_assets_config_data_protection_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/assets/config/data-protection.json */ "./src/assets/config/data-protection.json");
var src_assets_config_data_protection_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/data-protection.json */ "./src/assets/config/data-protection.json", 1);
/* harmony import */ var src_assets_config_error_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/assets/config/error.json */ "./src/assets/config/error.json");
var src_assets_config_error_json__WEBPACK_IMPORTED_MODULE_7___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/error.json */ "./src/assets/config/error.json", 1);
/* harmony import */ var src_assets_config_help_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/assets/config/help.json */ "./src/assets/config/help.json");
var src_assets_config_help_json__WEBPACK_IMPORTED_MODULE_8___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/help.json */ "./src/assets/config/help.json", 1);
/* harmony import */ var src_assets_config_home_json__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/assets/config/home.json */ "./src/assets/config/home.json");
var src_assets_config_home_json__WEBPACK_IMPORTED_MODULE_9___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/home.json */ "./src/assets/config/home.json", 1);
/* harmony import */ var src_assets_config_imprint_json__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/assets/config/imprint.json */ "./src/assets/config/imprint.json");
var src_assets_config_imprint_json__WEBPACK_IMPORTED_MODULE_10___namespace = /*#__PURE__*/__webpack_require__.t(/*! src/assets/config/imprint.json */ "./src/assets/config/imprint.json", 1);
...
let ConfigService = class ConfigService {
    ...
    get_content(pageName) {
        ...
        return src_assets_config_content_json__WEBPACK_IMPORTED_MODULE_5__.contents.filter(text => text.page == pageName)[0].content;
    }
    get_content_by_index(pageName, index = 0) {
        // tslint:disable-next-line: triple-equals
        return src_assets_config_content_json__WEBPACK_IMPORTED_MODULE_5__.contents.filter(text => text.page == pageName)[0].contents[index].content;
    }
    get_error(errorName) {
        // tslint:disable-next-line: triple-equals
        return src_assets_config_error_json__WEBPACK_IMPORTED_MODULE_7__.errors.filter(descr => descr.error == errorName)[0].descr;
    }
    get_mail_status_descr(pageName, status) {
        // tslint:disable-next-line: triple-equals
        const descriptions = src_assets_config_content_json__WEBPACK_IMPORTED_MODULE_5__.contents.filter(text => text.page == pageName)[0].descriptions;
        // tslint:disable-next-line: triple-equals
    ...
    get definite_article() {
        const gender = src_assets_config_app_config_json__WEBPACK_IMPORTED_MODULE_2__.noun_gender;
...
module.exports = __webpack_require__(/*! C:\Users\Hartm\Desktop\NOT IBHam\JugendForscht\Jugend forscht 2019\Frontend\diribit.io\src\main.ts */"./src/main.ts");
