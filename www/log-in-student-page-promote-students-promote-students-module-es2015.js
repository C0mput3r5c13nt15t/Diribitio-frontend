...
/* harmony import */ var _promote_students_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./promote-students.page */ "KNcl");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_promote_students_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./promote-students.page.html */ "++Th");
/* harmony import */ var _promote_students_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./promote-students.page.scss */ "2est");
...
let PromoteStudentsPage = class PromoteStudentsPage {
    constructor(activatedRoute, router, projectsService, studentsService, config, alertCtrl, alert) {
    ...
    ngOnInit() {
        ...
        this.getProject();
        this.getStudent();
        this.subscriptions.push(this.projectsService.update.subscribe(() => { this.getProject(); this.getStudent(); }), this.studentsService.update.subscribe(() => { this.getProject(); this.getStudent(); }));
    }
    /**
...
//# sourceMappingURL=log-in-student-page-promote-students-promote-students-module-es2015.js.map