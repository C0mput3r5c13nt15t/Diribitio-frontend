(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["log-in-leader-page-leader-project-generation-leader-project-generation-module"], {
    ...
    /***/
    function FHDN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LeaderProjectGenerationPageModule", function () {
        return LeaderProjectGenerationPageModule;
      });
      /* harmony import */
      ...
      var _leader_project_generation_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./leader-project-generation.page */
      "pwoe");
      ...
      var LeaderProjectGenerationPageModule = function LeaderProjectGenerationPageModule() {
        _classCallCheck(this, LeaderProjectGenerationPageModule);
      };

      LeaderProjectGenerationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function dwu4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function pwoe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LeaderProjectGenerationPage", function () {
        return LeaderProjectGenerationPage;
      });
      /* harmony import */
      ...
      var _raw_loader_leader_project_generation_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./leader-project-generation.page.html */
      "dwu4");
      /* harmony import */


      var _leader_project_generation_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./leader-project-generation.page.scss */
      "yFST");
      /* harmony import */
      ...
      var LeaderProjectGenerationPage = /*#__PURE__*/function () {
        function LeaderProjectGenerationPage(activatedRoute, router, projectsService, alert, config) {
          _classCallCheck(this, LeaderProjectGenerationPage);
        ...
        _createClass(LeaderProjectGenerationPage, [{
          key: "ngOnInit",
          ...
          value: function create() {
            ...
            this.projectsService.createProject('leaders', this.newProject, this.image).subscribe(function (data) {
              _this2.alert.alert(data.message);

              _this2.router.navigate([_this2.eventName + '/' + _this2.projectNoun + 'leiter/' + _this2.leaderUrl]);
      ...
      LeaderProjectGenerationPage.ctorParameters = function () {
        return [{
      ...
      LeaderProjectGenerationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function yFST(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=log-in-leader-page-leader-project-generation-leader-project-generation-module-es5.js.map