(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["log-in-student-page-registration-registration-module"], {
    ...
    /***/
    function i7b(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MWms(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var RegistrationPage = /*#__PURE__*/function () {
        function RegistrationPage(projectsService, studentsService, activatedRoute, router, alertCtrl, config) {
        ...
        _createClass(RegistrationPage, [{
          ...
          value: function getStudent() {
            ...
            this.studentsService.getSelfStudent().subscribe(function (data) {
              ...
              _this2.studentsService.getFriends().subscribe(function (friendData) {
          ...
          value: function appendFriendFunction() {
            ...
            this.studentsService.getStudentID(this.appendFriend).subscribe(function (data) {
    ...
    /***/
    function R2i6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=log-in-student-page-registration-registration-module-es5.js.map