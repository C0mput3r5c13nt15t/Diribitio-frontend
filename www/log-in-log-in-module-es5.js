  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["log-in-log-in-module"], {
    ...
    function dtn(module, __webpack_exports__, __webpack_require__) {
      ...
      var LogInPage = /*#__PURE__*/function () {
        function LogInPage(auth, router, studentsService, scheduleService, leadersService, adminsService, alert, config, cookieService) {
        ...
        _createClass(LogInPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.currentDate = this.currentDate = Object(_angular_common__WEBPACK_IMPORTED_MODULE_9__["formatDate"])(new Date(), 'yyyy-MM-dd', 'en');
            this.getSchedule();
          ...
          value: function log_in_from_storage() {
            ...
            if (this.cookieService.get('Diribitio-Session')) {
              var jwt = this.cookieService.get('Diribitio-Session');
