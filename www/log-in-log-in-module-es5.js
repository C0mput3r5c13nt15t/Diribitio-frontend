          ...
          value: function log_in_from_storage() {
            ...
            if (localStorage.getItem('jwt')) {
              ...
              this.auth.check_jwt(jwt).subscribe(function (data) {
                ...
                if (userAuth === 'admins') {
                  _this2.router.navigate([_this2.eventName + '/Admin/' + data.user_name]);
                } else if (userAuth === 'leaders') {
                  _this2.router.navigate([_this2.eventName + '/' + _this2.projectNoun + 'leiter/' + data.user_name]);
                } else if (userAuth === 'students') {
                  _this2.router.navigate([_this2.eventName + '/Schüler/' + data.user_name]);
                }
              }, function (error) {
          ...
          value: function LogInLeader(form) {
            ...
            this.leadersService.logInLeader(this.Leader).subscribe(function (data) {
              if (data.token) {
                ...
                _this4.router.navigate([_this4.eventName + '/' + _this4.projectNoun + 'leiter/' + data.user_name]);
          ...
          value: function LogInAdmin(form) {
            ...
            this.adminsService.logInAdmin(this.Admin).subscribe(function (data) {
              if (data.token) {
                ...
                _this5.router.navigate([_this5.eventName + '/Admin/' + data.user_name]);
